...
void CkCspW_getKeyContainer(HCkCspW cHandle, HCkStringW retval);
void CkCspW_putKeyContainer(HCkCspW cHandle, const wchar_t *newVal);
...
BOOL CkCspW_SaveLastError(HCkCspW cHandle, const wchar_t *filename);
...
const wchar_t *CkCspW__keyContainer(HCkCspW cHandle);
