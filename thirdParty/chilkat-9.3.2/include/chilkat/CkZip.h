...
class CkZip  : public CkObject
{
	...
	*/
	...
	bool OpenZip(const char *zipFileName, CkZipProgress *progress);
	...
	CkZipEntry *AppendData2(const char *fileName, const char *data, unsigned long dataLen);
	...
	void GetExeConfigParam(const char *name, CkString &outStr);
