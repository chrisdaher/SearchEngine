...
class CkCrypt2  : public CkMultiByteBase
{
	...
	bool EncodeBytes(const void *byteData, int numBytes, const char *encoding, CkString &outStr);
	...
	const char *encodeBytes(const void *byteData, int numBytes, const char *encoding);
