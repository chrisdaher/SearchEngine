...
class CkEmail : public CkMultiByteBase
{
	...
	void AddRelatedData2P(const char *data, unsigned long dataLen, const char *fileNameInHtml);
	bool AddRelatedDataP(const char *nameInHtml, const char *data, unsigned long dataLen, CkString *strContentId);
	...
	bool QEncodeBytes(const char *data, unsigned long dataLen, const char *charset, CkString &outEncodedStr);
	bool BEncodeBytes(const char *data, unsigned long dataLen, const char *charset, CkString &outEncodedStr);
	...
	bool GetFileContent(const char *filename, CkByteData &outData);
	...
	bool AddRelatedFile(const char *fileName, CkString &outStrContentID) { return AddRelatedFile(fileName,&outStrContentID); }


    	bool AddRelatedFile2(const char *fileNameOnDisk, const char *filenameInHtml);
	void AddRelatedData2P(const unsigned char *data, unsigned long dataLen, const char *fileNameInHtml);
	...
	bool AddRelatedDataP(const char *nameInHtml, const unsigned char *data, unsigned long dataLen, CkString *strContentId);
	bool AddRelatedDataP(const char *nameInHtml, const unsigned char *data, unsigned long dataLen, CkString &outStrContentId){return AddRelatedDataP(nameInHtml,data,dataLen,&outStrContentId);}
	...
	bool AddFileAttachment(const char *fileName, CkString &outStrContentType){return AddFileAttachment(fileName,&outStrContentType);}
	...
	*/
	...
	// in a WebBrowser.
	bool CreateTempMht(const char *inFilename, CkString &outTempMhtFilenameInOut);
	...
	bool QEncodeBytes(const unsigned char *data, unsigned long dataLen, const char *charset, CkString &outEncodedStr);
	// Takes a byte array of multibyte character data having the character encoding specified by the charset parameter, 
	// and returns a us-ascii B-Encoded string. 
	bool BEncodeBytes(const unsigned char *data, unsigned long dataLen, const char *charset, CkString &outEncodedStr);
	...
	const char *addRelatedDataP(const char *nameInHtml, const unsigned char *data, unsigned long dataLen);
